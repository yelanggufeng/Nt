package com.netintech.project.system.config.service;
...
import com.netintech.project.system.config.domain.Config;
import com.netintech.project.system.config.mapper.ConfigMapper;
...
public class ConfigServiceImpl implements IConfigService
{
    ...
    {
        config.setCreateBy(ShiroUtils.getUserStringId());
    ...
    {
        config.setUpdateBy(ShiroUtils.getUserStringId());
