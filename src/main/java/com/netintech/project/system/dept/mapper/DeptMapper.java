package com.netintech.project.system.dept.mapper;
...
public interface DeptMapper
{
    ...
    public List<Dept> selectGovDeptList(Dept dept);
    ...
    void updateDeptNameByID(SmallPark sp);

    int countParentById(Long id);
