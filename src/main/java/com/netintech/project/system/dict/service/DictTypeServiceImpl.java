...
import com.netintech.project.system.dict.mapper.DictTypeMapper;
...
public class DictTypeServiceImpl implements IDictTypeService
{
    ...
    {
        dictType.setCreateBy(ShiroUtils.getUserStringId());
    ...
    {
        dictType.setUpdateBy(ShiroUtils.getUserStringId());
