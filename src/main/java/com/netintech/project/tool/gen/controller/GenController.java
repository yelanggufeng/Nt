package com.netintech.project.tool.gen.controller;
...
import com.netintech.project.tool.gen.service.IGenTableColumnService;
import com.netintech.project.tool.gen.service.IGenTableService;
...
public class GenController extends BaseController
{
    ...
    {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"nt.zip\"");
        response.addHeader("Content-Length", "" + data.length);
        response.setContentType("application/octet-stream; charset=UTF-8");
        IOUtils.write(data, response.getOutputStream());
    }

    @RequiresPermissions("tool:gen:introduce")
