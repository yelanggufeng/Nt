package com.netintech.process.definition.service;
...
public class ProcessDefinitionService {
    ...
    public void startProcess(String assignee) {
        // 从系统用户表中查询用户信息
        User sysUser = userMapper.selectUserByLoginName(assignee);
...
//        runtimeService.startProcessInstanceByKey("oneTaskProcess");
     ...
     * @return
     */
    public Page<com.netintech.process.definition.domain.ProcessDefinition> listProcessDefinition(com.netintech.process.definition.domain.ProcessDefinition processDefinition) {
        PageDomain pageDomain = TableSupport.buildPageRequest();
        Integer pageNum = pageDomain.getPageNum();
        Integer pageSize = pageDomain.getPageSize();

        Page<com.netintech.process.definition.domain.ProcessDefinition> list = new Page<>();
        ...
        for (ProcessDefinition definition: processDefinitionList) {
            com.netintech.process.definition.domain.ProcessDefinition entity = new com.netintech.process.definition.domain.ProcessDefinition();
