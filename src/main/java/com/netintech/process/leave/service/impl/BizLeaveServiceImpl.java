package com.netintech.process.leave.service.impl;
...
//                        .singleResult();
    ...
    public ProcessInstance submitApply(BizLeaveVo entity, String applyUserId) {
        ...
        // 下一节点处理人待办事项
        bizTodoItemService.insertTodoItem(processInstanceId, "leave");
    ...
    public void complete(BizLeaveVo leave, Boolean saveEntity, String taskId, Map<String, Object> variables) {
        ...
        for (BizTodoItem update: updateList) {
            ...
            if (update.getTodoUserId().equals(ShiroUtils.getUserStringId())) {
                update.setIsView("1");
        ...
        // 下一节点处理人待办事项
       int i = bizTodoItemService.insertTodoItem(leave.getInstanceId(), "leave");
    }
