package com.netintech.process.leavecountersign.controller;
...
public class BizLeaveCounterSignController extends BaseController {
    ...
    public TableDataInfo list(BizLeaveVo bizLeave) {
        if (!com.netintech.project.system.user.domain.User.isAdmin(ShiroUtils.getUserId())) {
    ...
    public AjaxResult addSave(BizLeaveVo bizLeave) {
        ...
        if (com.netintech.project.system.user.domain.User.isAdmin(userId)) {
