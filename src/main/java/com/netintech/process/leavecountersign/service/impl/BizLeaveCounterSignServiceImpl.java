package com.netintech.process.leavecountersign.service.impl;
...
import com.netintech.process.leave.mapper.BizLeaveMapper;
import com.netintech.process.leavecountersign.service.IBizLeaveCounterSignService;
...
public class BizLeaveCounterSignServiceImpl implements IBizLeaveCounterSignService {
    ...
    public BizLeaveVo selectBizLeaveById(Long id) {
        ...
        User sysUser = userMapper.selectUserByLoginName(leave.getApplyUser());
        if (sysUser != null) {
    ...
    public List<BizLeaveVo> selectBizLeaveList(BizLeaveVo bizLeave) {
        ...
        for (BizLeaveVo leave: list) {
            User sysUser = userMapper.selectUserByLoginName(leave.getCreateBy());
            if (sysUser != null) {
                leave.setCreateUserName(sysUser.getUserName());
            }
            User sysUser2 = userMapper.selectUserByLoginName(leave.getApplyUser());
            if (sysUser2 != null) {
...
//                        .singleResult();
    ...
    public List<BizLeaveVo> findTodoTasks(BizLeaveVo leave, String userId) {
        ...
        for (Task task : tasks) {
            ...
            User sysUser = userMapper.selectUserByLoginName(leave2.getApplyUser());
    ...
    public void complete(BizLeaveVo leave, Boolean saveEntity, String taskId, Map<String, Object> variables) {
        ...
        taskService.claim(taskId, ShiroUtils.getUserStringId());
        ...
        for (BizTodoItem update: updateList) {
            ...
            if (update.getTodoUserId().equals(ShiroUtils.getLoginName())) {
                ...
                update.setHandleUserId(ShiroUtils.getUserStringId());
        ...
        // 下一节点处理人待办事项
        bizTodoItemService.insertTodoItem(leave.getInstanceId(), "leaveCounterSign");
    }
    ...
    public ProcessInstance submitApplyByCounterSign(BizLeaveVo entity, String applyUserId, Map<String, Object> variables) {
        ...
        // 下一节点处理人待办事项
        bizTodoItemService.insertTodoItem(processInstanceId,  "leaveCounterSign");
