package com.netintech.common.constant;
...
public class UserConstants
{
    ...
    /** 字典名称是否唯一的返回结果码 */
    public final static String LEVEL_DICT_NAME_UNIQUE = "0";
    public final static String LEVEL_DICT_NAME_NOT_UNIQUE = "1";

    /** 园区名称是否唯一的返回结果码 */
    public final static String PARK_NAME_UNIQUE = "0";
    public final static String PARK_NAME_NOT_UNIQUE = "1";

    /** 企业名称是否唯一的返回结果码 */
    public final static String ENTERPRISE_NAME_UNIQUE = "0";
    public final static String ENTERPRISE_NAME_NOT_UNIQUE = "1";

    /** 企业名称是否唯一的返回结果码 */
    public final static String UPGRADE_NAME_UNIQUE = "0";
    public final static String UPGRADE_NAME_NOT_UNIQUE = "1";
}
